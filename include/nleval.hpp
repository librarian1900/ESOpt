...
struct MODEL_API ConstraintAutodiffEvaluator
{
	union {
		f_funcptr p = nullptr;
...
struct MODEL_API ObjectiveAutodiffEvaluator
{
	union {
		f_funcptr p = nullptr;
		f_funcptr_noparam nop;
...
struct MODEL_API LinearEvaluator
{
	int n_constraints = 0;
...
struct NonlinearEvaluator
{
	...
	struct ConstraintGraphGroup
	{
		...
		// temp private hessian array for parall modified by kuan@11.25.2025
	...
	// record hessian nnz for constraint hessian parallel computation modified by kuan@06.03.2026
	size_t m_global_hessian_nnz = 0;
